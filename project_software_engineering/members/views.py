...
def Search(request):
  ...
  print("////////////////////////////////////////////////////")
  print(r1)
  Find_U = face_recognition.load_image_file('/home/deeplearning/myworld/media/Find_Images/' + str(r1))
  ...
  for testuser in Img_Find:
    ...
    Lost_U = face_recognition.load_image_file('/home/deeplearning/myworld/media/Lost_Images/' + Sr_Lost_User[-1])
