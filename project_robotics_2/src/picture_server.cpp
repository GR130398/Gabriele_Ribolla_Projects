...
#include "project_2/image_save.h"
#include <sstream>
...
public:
    ...
    bool check_and_print(project_2::image_save::Request &req,
                         project_2::image_save::Response &res){
...
int main(int argc, char **argv)
{
    ...
    ros::ServiceServer service = nh.advertiseService("/save_image", &PictureServer::check_and_print, &mi);
    image_transport::Subscriber sub = it.subscribe("/image_topic", 1, &PictureServer::imageCallback, &mi);
