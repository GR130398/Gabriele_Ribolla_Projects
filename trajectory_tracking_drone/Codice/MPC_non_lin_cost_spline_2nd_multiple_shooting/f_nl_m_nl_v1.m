...
%     zdot = A*z_sim(:,ind-1) + B* u;
%     zdot               =   linquadcopter_augmented(0,z_sim(:,ind-1),u,th);
...
errorLag = norm(vetErroreTot) - norm(vetErroreContour);
cost1 = errorLag^2; % + norm(vetErroreContour)^2;
